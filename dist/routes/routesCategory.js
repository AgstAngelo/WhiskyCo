...
routes.post("/category", isAdmin_1.default, controllerCategory_1.default.create);
routes.get("/category", controllerCategory_1.default.findAll);
routes.get("/category/:id", controllerCategory_1.default.findOne);
routes.put("/category/:id", isAdmin_1.default, controllerCategory_1.default.update);
